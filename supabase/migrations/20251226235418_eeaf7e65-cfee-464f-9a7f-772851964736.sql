-- Drop the view and recreate without security definer (default is security invoker)
DROP VIEW IF EXISTS public.bookings_organizer_view;

-- Recreate view with SECURITY INVOKER explicitly (uses caller's permissions)
CREATE VIEW public.bookings_organizer_view
